import UnsplashImage from "@/app/_components/UnsplashImage";
...
export default function Home() {
  return (
    <div className="grid grid-cols-1 gap-6 leading-10 md:grid-cols-3">
      ...
      <div className="col-span-1 flex min-h-96 w-full justify-center md:justify-start">
        <UnsplashImage
      ...
      <div className="col-span-1 space-y-8 md:col-span-2">
        ...
        <p>
          I want to create solutions with real impact: applications that improve
          lives, support communities, and create positive change. My goal is for
          my work to help people and organizations operate more efficiently,
          sustainably, or inclusively.
        </p>
      </div>
      <div className="col-span-1 md:col-span-3">
        <p>
